...
namespace WebBase.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        private readonly Data.WebBaseDbContext _context;

        public LoginModel(SignInManager<Usuario> signInManager,
            ILogger<LoginModel> logger,
            Data.WebBaseDbContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //verifica se a senha do admin é a inicial
                    ...
                    {
                        return LocalRedirect(Url.Content("/Usuarios/Edit/"+Usuario.Id));
                    }

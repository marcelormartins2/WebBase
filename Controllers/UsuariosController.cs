...
namespace WebBase.Controllers
{
    ...
    {
        private readonly WebBaseDbContext _context;
        ...
        public UsuariosController(WebBaseDbContext context, 
        ...
        public async Task<IActionResult> Edit(String id)
        {
            ...
            if (User.IsInRole("Administrator") || User.Identity.Name == Usuario.UserName)
            {
                return View(Usuario);
            }
